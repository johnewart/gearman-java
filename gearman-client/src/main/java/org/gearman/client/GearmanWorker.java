...
public class GearmanWorker implements Runnable {
    private final ConnectionPool connectionPool;
    private final Map<String, GearmanFunction> callbacks;
    private static Logger LOG = LoggerFactory.getLogger(GearmanWorker.class);
    ...
    private GearmanWorker(GearmanWorker other)
    {
    ...
    public static class Builder {
        ...
        public GearmanWorker build() {
            return new GearmanWorker(worker);
        }
